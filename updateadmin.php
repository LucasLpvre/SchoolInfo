<?php
	...
	$sql = "UPDATE t_eleves SET nom='$nom', prenom='$prenom', classe='$classe', email='$email', jour='$jour', mois='$mois', annee='$annee', sexe='$sexe', adresse='$adresse', ville='$ville', code_postal='$code_postal', tel='$tel' WHERE id=$id";
