<?php
	...
	if (isset($_SESSION['login']) && isset($_SESSION['pwd'])) {
		...
		echo '<body onLoad="alert(\'Aucun nom entré !\')">';
		echo '<meta http-equiv="refresh" content="0;URL=index.php">';
	}
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr" dir="ltr">
	...
	<head 'Content-type: text/html; charset='UTF8'>
		<title>Mise à jour fiche</title>
		<link rel="stylesheet" href="css/Maj.css" media="all" rel="stylesheet" type="text/css" >
	...
	<body>
		...
		<div id="conteneurSite">
			<div id="entete">
			 	<br>Bienvenue <?php echo $tab[0]['prenom'] ; ?> <?php echo $tab[0]['nom'] ; ?> !<br> Vous pouvez modifier vos informations ci-dessous : </br>
				<div id="entete_centre">
				</div><!-- div entete centre -->
			</div>

				<div class="container">
					<form id="recherche" method="POST" action="update.php" >
					    ...
					    <input type="password" placeholder="Mot de passe" name="mot_de_passe" id="mot_de_passe" value="<?php echo $tab[0]['mot_de_passe'] ; ?>" required><br>
